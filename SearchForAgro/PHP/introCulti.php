    ...
    <header class="mike py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder">Cultivos</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Featured blog post-->
                <div class="card mb-4">
                    <a href="#!"><img class="card-img-top" src="plant-4036130_1280.jpg" alt="..." /></a>
                    <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="cebolla.jpg" alt="..." /></a>
                            <div class="card-body">
                        ...
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="patatoe.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                    ...
                    <div class="col-lg-6">
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="arroz.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                        ...
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="platano.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <input class="form-control" type="text" placeholder="Introduzca el término de búsqueda..."
